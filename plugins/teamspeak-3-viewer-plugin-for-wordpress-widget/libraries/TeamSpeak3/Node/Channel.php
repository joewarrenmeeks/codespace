 ...
 *
 * $Id: Channel.php 2010-01-10 22:52:12 sven $
 * 
 ...
 * 
 * @package  TeamSpeak3_Node_Channel
...
class TeamSpeak3_Node_Channel extends TeamSpeak3_Node_Abstract
{
   ...
   */
  public function __construct(TeamSpeak3_Node_Server $host, array $info, $index = "cid")
  {
    $this->parent = $host;
    $this->nodeInfo = $info;
   ...
   * @return array
   */
  public function subChannelList()
  {
    $channels = array();
  ...
  {
    return $this->getParent()->channelClientPermList($this->getId(), $cldbid);
  }
  ...
  /**
   * Adds a specified permission to a client in the channel.
   *
   * @param  integer $cldbid
  ...
  public function clientPermAssignByName($cldbid, $permname, $permvalue)
  {
    ...
    return $this->clientPermAssign($cldbid, $permid, $permvalue);
  }
  ...
  /**
   * Removes a specified permission from a client in the channel.
   *
   * @param  integer $cldbid
   * @param  integer $permid
   * @return void
  ...
  public function clientPermRemoveByName($cldbid, $permname)
  {
    ...
    return $this->clientPermRemove($cldbid, $permid);
  }
  ...
  {
    return $this->getParent()->channelPermList($this->getId());
  }
  ...
  /**
   * Adds a specified permission to the channel.
   *
   * @param  string $permname
   * @param  integer $permvalue
   * @return void
  ...
  {
    return $this->getParent()->channelPermRemove($this->getId());
  }
  
  /**
   * Removes a specified permission from the channel.
   *
   * @param  string $permname
   * @return void
   */
  ...
  /**
   * Returns detailed information about one or more specified files stored in the channels file repository.
   *
   * @param  string  $cpw
   * @param  string  $path
   * @return array
